...
//   // Ensure your useQueryHendler returns an object matching the DataType structure
//   const { data, isError, isLoading }: DataType<BlogTypeItem[]> = useQueryHendler({
//     url: "user/blog",
//     pathname: `/blog?search=${search}`,
//     params: { search },
...
//       <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
//         {isError || isLoading
//           ? blog_card_loader() // Assuming this returns JSX elements (skeleton)
//           : data?.map((value) => (
//               <div key={value._id} className="h-full">
//                 {/* Spreading ...value works because BlogCard takes BlogTypeItem as props */}
//                 <BlogCard {...value} />
//               </div>
//             ))}
//       </div>
